...
export class Junction {
     ...
     */
    hasInputPipe(name) {
        return (this.hasPipe(name) && this.pipeTypesMap.get(name) === JunctionType.INPUT);
    }
    /**
     ...
     */
    hasOutputPipe(name) {
        return (this.hasPipe(name) && this.pipeTypesMap.get(name) === JunctionType.OUTPUT);
    }
    /**
    ...
    addPipeListener(inputPipeName, listener) {
        ...
        if (this.hasInputPipe(inputPipeName)) {
            ...
            success = (pipe === null || pipe === void 0 ? void 0 : pipe.connect(new PipeListener(listener))) || false;
        }
        return success;
    }
    /**
